  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
        ...
        /*String name = (String)udb.getName();
        String year = (String)udb.getStrYear();
        String month = (String)udb.getStrMonth();
        String day = (String)udb.getStrDay();
        String type = (String)udb.getStrType();
        String tell = (String)udb.getTell();
        String comment = (String)udb.getComment();
        */
        if(udb == null){
...
if(udb.getStrYear().equals("")){out.print("----");}else{out.print(udb.getStrYear());}
      out.write("\"></option>\n");
      out.write("            ");
      ...
      out.write("            <option value=\"");
if(udb.getStrMonth().equals("")){out.print("--");}else{out.print(udb.getStrMonth());}
      out.write("\"></option>\n");
      out.write("            ");
      ...
      out.write("            <option value=\"");
if(udb.getStrDay().equals("")){out.print("--");}else{out.print(udb.getStrDay());}
      out.write("\"></option>\n");
      out.write("            ");
...
if(udb.getStrType().equals("1")){out.print("checked");}
      out.write(">エンジニア<br>\n");
      out.write("        <input type=\"radio\" name=\"type\" value=\"2\" ");
if(udb.getStrType().equals("2")){out.print("checked");}
      out.write(">営業<br>\n");
      out.write("        <input type=\"radio\" name=\"type\" value=\"3\" ");
if(udb.getStrType().equals("3")){out.print("checked");}
      out.write(">その他<br>\n");
      out.write("        <br>\n");
      out.write("\n");
      out.write("        電話番号:\n");
