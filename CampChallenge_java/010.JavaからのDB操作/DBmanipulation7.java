 ...
 * @author 将也
 */
public class DBmanipulation7 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            //「profilesID」が1のレコードを上書きする処理。
            pst = con.prepareStatement("update profiles set name = '松岡 修三', age = 48, birthday = '1967-11-06' where profilesID = ?");
            pst.setInt(1, 1);
            
            pst.executeUpdate();
            
            //確認の為、変更したprofilesID「1」を検索する。
            pst = con.prepareStatement("select * from profiles where profilesID = 1");
